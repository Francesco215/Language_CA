...
const fpsSliderHop = document.getElementById("Hop_fps-slider");
const fpsValueHop = document.getElementById("Hop_fps-value");
let isSimulationPausedHop = true;
...
initFpsSlider(
  fpsSliderHop,
  fpsValueHop,
  document.getElementById('Hop_fps-slider-tickmarks'),
  updateHop
);