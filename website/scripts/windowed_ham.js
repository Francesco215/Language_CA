...
if (window.navigator.userAgent.indexOf("Safari") != -1) {
    // Get a reference to the SVG element and the image file name
    var svgElement = document.getElementById("graph");
    var imageFileName = "website/images/local_ham.png";

    svgElement.setAttribute("width","1050")
    ...
    image.setAttribute("href", imageFileName);
